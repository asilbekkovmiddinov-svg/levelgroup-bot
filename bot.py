...
from handlers.admin_arena_draw_edit import router as admin_arena_draw_edit_router
...
from handlers.admin_arena_season import router as admin_arena_season_router
...
dp.include_router(admin_arena_draw_edit_router)
...
dp.include_router(admin_arena_season_router)

...
REQUIRED_CHANNELS = [
    {"chat_id": os.getenv("REQUIRED_CHANNEL_BEK_PESSERUZ", "@Bek_PesserUz").strip(), "title": "Bek_PesserUz 🇺🇿", "url": "https://t.me/Bek_PesserUz"},
...
CAMPAIGN_MINIAPP_URL = (os.getenv("CAMPAIGN_MINIAPP_URL") or MINIAPP_URL).strip()
...
ARENA_MINIAPP_URL = os.getenv("ARENA_MINIAPP_URL") or MINIAPP_URL
